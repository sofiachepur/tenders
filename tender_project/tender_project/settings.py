...
SECRET_KEY = 'django-insecure-55kpf6f)tw%tay5@n)3oe5e6h+cry$$!$x$5=1q6*r8v4*a5p4'
...
EMAIL_HOST = 'smtp.gmail.com'           # або твій поштовий сервер
EMAIL_PORT = 587                        # для TLS
EMAIL_USE_TLS = True                     # або False для SSL
EMAIL_USE_SSL = False                    # не одночасно з TLS
EMAIL_HOST_USER = 'chepursofia27@gmail.com'
EMAIL_HOST_PASSWORD = 'chepursofia27'
